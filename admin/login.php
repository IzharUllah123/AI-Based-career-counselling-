...
<body>
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="main.php" style="padding-bottom: 10px;">Career AI</a>
					</div>
					<!-- /Logo -->
    ...
    <div class="wrapper" >
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" style="display: block; margin: auto; width: 100%" value="Login">
            </div>
