				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">AI Based Career Couseling System</h1>
							...
							<?php
								...
								<?php else: ?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Hi, <?php echo htmlspecialchars($_SESSION["name"]); ?> !<br><b>Discover yourself,<br>Take the test to find the perfect role for you after Engineering</b></p>

									<a class="main-button icon-button" href="http://localhost:5000/?name=<?php echo $_SESSION["name"];?>">Get Started!</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Career AI</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Career AI</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								<?php else: ?>
									<a href="http://localhost:5000/?name=<?php echo $_SESSION["name"];?>"><h4>Career Prediction</h4></a>
				...
				<div class="row">
					...
					<div class="col-md-6">
							...
							<?php
								...
								<?php else: ?>
									<h2 class="white-text" style="font-size: 30px; width:700px ;">Hi, <b><?php echo htmlspecialchars($_SESSION["name"]); ?> !</b></h2>
